  ...
  <div>
    ...
    class="bg-black hover:bg-[#282828] rounded-full p-0.5 mr-8 mt-0.5 cursor-pointer">
      <div class="flex items-center">
        <img class="rounded-full" width="27" src="https://yt3.ggpht.com/yti/AHyvSCCtdT3MeyQlkbDdHWmpfmZeaHDzlK3loK9KlbsX8w=s88-c-k-c0x00ffffff-no-rj-mo" alt="">
    ...
    <span
      v-if="openMenu"
      class="
        fixed w-[190px] bg-[#282828] shadow-2xl z-50 rounded-sm top-[52px] right-[35px] p-1 cursor-pointer
      "
    >
    ...
    <div id="sideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
      ...
      <ul>
        ...
        <MenuItem :iconSize="24" name="Create Playlist" iconString="playlist"  page-url="/playlist"/>
        <MenuItem class="-ml-[1px]" :iconSize="27" name="Liked Songs" iconString="liked"  page-url="/liked"/>
      </ul>
